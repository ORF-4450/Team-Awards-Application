...
yearInput = tkinter.Entry(mainWindow, selectbackground="#c8ae40", selectforeground="white")
yearInput.grid(row=0, column=0, sticky="NSEW")
submitButton = tkinter.Button(mainWindow, text="Submit", command=submitRequest, background="#063388", foreground="white", activebackground="#063388", activeforeground="white")
...
teamListBox = tkinter.Listbox(mainContainer, selectbackground="#c8ae40", selectforeground="white")
...
teamAwardBox = tkinter.Listbox(awardContainer, selectbackground="#c8ae40", selectforeground="white")
